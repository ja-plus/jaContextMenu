...
var Menu = /*#__PURE__*/function () {
  ...
  function Menu(level, option, innerOption) {
    ...
    _defineProperty(this, "innerOption", void 0);
  ...
  _createClass(Menu, [{
    ...
    value: function init() {
      ...
      this.el = h("ul.".concat(config.wrapperClassName, ".").concat(config.wrapperClassName, "-lv").concat(this.level), {
        ...
        style: {
          ...
          position: (_this$innerOption = this.innerOption) === null || _this$innerOption === void 0 ? void 0 : _this$innerOption.position // fix
    ...
    value: function calcPosition(e) {
      ...
      var translateY = e.clientY + (this.level === 0 && !this.innerOption.position ? window.scrollY : 0); // right not have enough space
